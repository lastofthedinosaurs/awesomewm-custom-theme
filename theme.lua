...
theme.fg_focus      = "#B5BFE2"
theme.fg_urgent     = "#B5BFE2"
theme.fg_minimize   = "#B5BFE2"
...
-- https://github.com/catppuccin/wallpapers/tree/main/gradients
theme.wallpaper = "~/.config/awesome/magenta_blue.png"
